...
public class ReadWorldDataFile {
	...
	public enum EntityIdentifier {
		...
		goldbars, jewel, coin, ring, moneybag, chalice, mobile, warchest, treasurechest, sword, lockpick, zombie, dragon, ogre, roastboar, mead, axe, key, bread
	...
	private static Pickup parsePickUpData(String text) {
		...
		case treasurechest:
			Valuables v = (Valuables) parsePickUpData(tokens[2] + " " + tokens[3]);
		...
		for (int i = 0; i < numberOfRooms; i++) {
			...
			do {
				...
				case endquest:
					...
					break;
				case connect:
					// read and print the meta tag for connections and connections text (as an
					// array).
